<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-fucsia-500 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <BreezeNavLink :href="route('webapp.index')" :active="route().current('webapp. index')" class="text-white">
                                    Inicio
                                </BreezeNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1 ">
                        <BreezeResponsiveNavLink :href="route('webapp.index')" :active="route().current('webapp.index')" class="text-white">
                            Inicio
