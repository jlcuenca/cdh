<template>
    <div class="w-full min-h-full grid-cols-1 md:grid grid-cols-5 bg-gray-50">
        <div class="min-h-full sm:min-h-screen">
            <!--Left sidebar-->
            <div class="h-20 w-full bg-white own-shadow hidden md:flex px-2 items-center">
                <div class="w-full flex">
                    <Link :href="route('manager.index')">
                        <div class="h-12">
                            <img src="/images/logo_default.png" class="rounded-full h-12">
                        </div>
                    </Link>
                </div>
            </div>
