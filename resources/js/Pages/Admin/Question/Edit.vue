                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6">
                      ...
                      <input type="text" id="title" v-model="question.title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm  border-gray-300 rounded-md" autofocus>
                    </div>
                    ...
                    <div class="col-span-6">
                      ...
                      <div class="mt-1">
                        <textarea id="about" v-model="question.description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full  border-gray-300 rounded-md"></textarea>
                      </div>
...
export default {
  ...
  methods: {
    save() {
      axios({
        method: 'patch',
        url: route('manager.evaluation.sections.questions.update', {evaluation: this.diagnose.id, section: this.diagnoseSection.id, question: this.question.id}),
        data: {
          title: this.question.title,
          description: this.question.description,
          answers_type: this.form.answers_type
        },
      }).then(({data}) => {
        this.$swal.fire({
          title: 'Éxito',
  ...
  mounted() {
    this.form.answers_type = this.answerType;
  }
}
</script>
