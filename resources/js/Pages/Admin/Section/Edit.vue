          ...
          <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
              <p class="mt-1  text-gray-600">
                Editar informacion de la sección
              </p>
            </div>
          </div>
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6">
                      ...
                      <input type="text" v-model="section.title" id="title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm  border-gray-300 rounded-md" autofocus>
                    </div>
                    ...
                    <div class="col-span-6">
                      ...
                      <div class="mt-1">
                        <textarea id="excerpt" v-model="section.excerpt" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full  border-gray-300 rounded-md"></textarea>
                      </div>
...
export default {
  ...
  methods: {
    save() {
      axios({
        method: 'patch',
        url: route('manager.evaluation.sections.update', {evaluation:this.diagnose.id, section: this.section.id}),
        data: this.section,
      }).then(({data}) => {
        this.$swal.fire({
          title: 'Éxito',
