                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6">
                      ...
                      <div class="mt-1">
                        <textarea id="about" v-model="form.excerpt" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full  border-gray-300 rounded-md"></textarea>
                      </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <select id="is_active" v-model="form.is_active" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 ">
...
export default {
  ...
  methods: {
    save() {
      axios({
        method: 'post',
        url: route('manager.evaluation.store'),
        data: this.form,
      }).then(({data}) => {
        this.$swal.fire({
          title: 'Éxito',
