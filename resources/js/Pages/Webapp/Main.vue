    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-12 px-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                    <div v-for="(record, key) in courses.data" class="w-full">
                        <div class="bg-white shadow rounded-lg overflow-hidden">
                            ...
                            <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-fucsia-500">
                                ...
                                <div class="flex items-center pt-2">
                                    <Link :href="route('webapp.courses.lessons.index', {id: record.id})" :class="record.progress_count === 0 ? 'bg-blue-500 text-white border-blue-600 hover:bg-blue-600' : 'bg-fucsia-600 text-white border-fucsia-600 hover:bg-fucsia-500'" class="text-white w-full transition text-center rounded-md  px-3 py-2 font-bold shadow border">
                ...
                <div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div v-for="(record, key) in records" class="w-full">
                        <div class="bg-white shadow rounded-lg overflow-hidden">
                            <Link :href="route('webapp.courses.lessons.index', {id: record.id})">
                                <div class="bg-cover bg-center h-56 p-4 hover:opacity-70" :style="record.image_url ? `background-image: url(/storage/${record.image_url})` : 'background-color: #4a4a4a;'">
...
export default {
  ...
  props: ['records', 'courses', 'paginate'],
}
</script>
